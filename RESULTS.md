...
[`results/paper/table_results.csv`](results/paper/table_results.csv). Details
about which older aggregate files could be matched to the final tables are kept
in the [result reconciliation record](docs/RESULT_RECONCILIATION.md) for
maintainers.
