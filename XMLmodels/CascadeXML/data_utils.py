...
from transformers import BertTokenizer, RobertaTokenizer, XLNetTokenizer, DebertaTokenizer
import re
...
def get_tokenizer(model_name):
    if 'deberta_large' in model_name:
        print('loading deberta_large tokenizer')
    ...
    elif 'bert_large' in model_name:
        print('loading bert_large tokenizer')
        tokenizer = BertTokenizer.from_pretrained('google-bert/bert-large-uncased', do_lower_case=True)
    elif 'deberta' in model_name:
        print('loading deberta-base tokenizer')
...
def get_inv_prop(dataset, Y):
    ...
    A = {'Eurlex': 0.6, 'LF-Amazon-131K': 0.6, 'Amazon-670K': 0.6, 'Amazon-3M': 0.6, 'AmazonCat-13K': 0.55, 'Wiki-500K' : 0.5, 'Wiki10-31K' : 0.55, 'NYTimes' : 0.55, 'WOS' : 0.55, 'RCV1' : 0.55, '20ng' : 0.55, 'Ohsumed' : 0.55, 'GoEmotions' : 0.55, 'EconBiz' : 1.5}
    B = {'Eurlex': 2.6, 'LF-Amazon-131K': 2.6, 'Amazon-670K': 2.6, 'Amazon-3M': 2.6, 'AmazonCat-13K': 1.5, 'Wiki-500K': 0.4, 'Wiki10-31K': 1.5, 'NYTimes' : 0.55, 'WOS' : 0.55, 'RCV1' : 0.55,'20ng' : 0.55, 'Ohsumed' : 0.55, 'GoEmotions' : 0.55, 'EconBiz' : 1.5}
