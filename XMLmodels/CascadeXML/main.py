...
EVAL_SCHEME = {'LF-Amzon-131K': 'weighted', 'Amazon-670K': 'weighted', 'Amazon-3M': 'weighted', 'Wiki-500K' : 'level', 'AmazonCat-13K': 'level', 'Wiki10-31K': 'weighted', 'NYTimes': 'weighted','WOS': 'weighted','RCV1': 'weighted','Ohsumed': 'weighted','20ng': 'weighted','GoEmotions': 'weighted'}
...
def main(params):
    ...
    if params.sparse:  # only for A3M and larger datasets
        ...
        runner = Runner(params, train_dl, test_dl, inv_prop, params.top_k)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_patience', type=int, default=5) #new 
    ...
    parser.add_argument('--tree_depth', type=int, nargs='+', default=[9, 12])  #b_factor new
