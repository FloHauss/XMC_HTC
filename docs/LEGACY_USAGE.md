# Legacy model and preprocessing instructions

> This file preserves the repository's previous root README for provenance.
> It contains known stale paths and wording and has not yet been verified as a
> fresh-checkout release guide. Prefer the current root README and the dedicated
