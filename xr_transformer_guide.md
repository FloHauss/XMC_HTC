...
This installation has not yet been reproduced during release preparation and
must not be described as verified solely because the source-level test suite
passes.
...
is checked automatically, but the configurations and retained compact results
still require reconciliation with the final paper tables.
